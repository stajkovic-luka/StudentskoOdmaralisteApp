...
public class FakturaForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelStavke.setFont(new java.awt.Font("Segoe UI", 2, 13)); // NOI18N
    ...
    private void jButtonNoviActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNoviActionPerformed
        try {
            FakturaOdmora placeholderFaktura = Controller.getInstance().createInvoice(ulogovaniSluzbenik);
            JOptionPane.showMessageDialog(this, "Sistem je kreirao fakturu odmora.", "Uspeh", JOptionPane.INFORMATION_MESSAGE);
            NovaFakturaForm nf = new NovaFakturaForm(this, true, placeholderFaktura, ulogovaniSluzbenik);
            nf.setVisible(true);
            jButtonPrikaziSveActionPerformed(evt);
        } catch (Exception e) {
