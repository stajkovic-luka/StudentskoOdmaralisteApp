...
public class IzmeniStudent extends javax.swing.JDialog {
    ...
    public IzmeniStudent(Frame parent, boolean modal, Student selektovani) {
        super(parent, modal);
        this.selektovaniStudent = selektovani;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelNaslov.setText("Izmeni studenta");
    ...
    private void popuniPolja() {
        ...
        jTextFieldIme.setText(selektovaniStudent.getIme());
        jTextFieldPrezime.setText(selektovaniStudent.getPrezime());
        jTextFieldTelefon.setText(String.valueOf(selektovaniStudent.getBrTelefona()));
        jCheckBoxBudzet.setSelected(selektovaniStudent.isBudzet());

        if (selektovaniStudent.getFakultet() == null) {
            return;
        }

        long idFakultet = selektovaniStudent.getFakultet().getIdFakultet();
        for (int i = 0; i < fakulteti.size(); i++) {
            if (fakulteti.get(i).getIdFakultet() == idFakultet) {
                jComboBoxFakultet.setSelectedIndex(i);
                return;
            }
        }
    }
